		...
		<table class="tg" width="100%" style="margin-top: 35px;">
			...
			<tbody>
				<tr>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K1']=="Jelas"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K1']=="Sobek"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K1']=="Kabur"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
				...
				<tr>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K2']=="Bersih"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K2']=="Ada Potongan kertas/kotor (debu)"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
				...
				<tr>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;">1. Bersih</td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K3']=="Bersih"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K3']=="Kotor"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
				...
				<tr>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K4']=="Hidup"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K4']=="Mati"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
				...
				<tr>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K5']=="Berfungsi"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					...
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"><?php if($query['K5']=="Tidak berfungsi"){ ?> <img src="uploadfile/pngegg.png" width="20">  <?php }else{ ?>  <?php } ?></td>
				</tr>
				<tr>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
					<td class="tg-2c25" style="font-size:14px;font-weight: ; padding: 4;"></td>
