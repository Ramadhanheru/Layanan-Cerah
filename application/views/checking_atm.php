            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Table Checking ATM Banking Hall</h4>
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Form Checking atm Bankink Hall</h4>
                                <?php 
...
echo mdate($datestring); ?>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Denominasi</label> <br>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Kondisiruang ATM</label> <br>
                                            <label class="col-form-label">Keberadaan :</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Slip/bukti transaksi</label> <br>
                                            <label class="col-form-label">Keberadaan :</label>
