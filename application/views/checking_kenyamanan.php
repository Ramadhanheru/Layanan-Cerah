        ...
        <div class="col-12 ">
            <div class="card">
                <div class="card-body">
                    ...
                    <a class="btn btn-danger mb-3" style="margin-left: 15px;" href="<?= base_url('welcome/pdf_checking_kenyamanan') ?>" target="_blank"><span class="ti-files" style="margin-right: 10px;"></span>Report Pdf</a>
                        ...
                        <table id="dataTable2" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $q->petugas1; ?></td>
                                    <td><?= $q->petugas2; ?></td>
                                    <td><a href="<?= base_url('welcome/print_checking_kenyamanan/').$q->id; ?>" target="_blank"><span class="ti-printer" style="margin-right: 5px;"></span>Print</a> ||
                                    <a href="" data-toggle="modal" data-target="#exampleModalLong-<?= $q->id ?>"><span class="ti-pencil-alt" style="margin-right: 5px;"></span>Edit</a> || <a href="<?= base_url('welcome/hapus_checking_kenyamanan/').$q->id; ?>" onclick="return confirm('Are you sure want to delete this?');"><span class="ti-trash" style="margin-right: 5px;"></span>Hapus</a></td>
                                </tr>
                                <!-- Modal -->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Form Edit Checking Kenyamanan</h5>
                                                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                            </div>
                                            <form action="<?= base_url('welcome/edit_checking_kenyamanan/').$q->id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <table id="dataTable2" class="text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $q->petugas1; ?></td>
                                    <td><?= $q->petugas2; ?></td>
                                    <td><a href="<?= base_url('cabang/print_checking_kenyamanan/').$q->id; ?>" target="_blank" >Print</a></td>
                                </tr>
                                <?php $no++; } ?>
                            </tbody>
                        </table>
